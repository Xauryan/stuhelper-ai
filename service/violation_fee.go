...
func HasCSAMViolationMarker(err *types.StuHelperAIError) bool {
	if err == nil {
		return false
	}
...
func WrapAsViolationFeeGrokCSAM(err *types.StuHelperAIError) *types.StuHelperAIError {
	if err == nil {
		return nil
	}
...
func NormalizeViolationFeeError(err *types.StuHelperAIError) *types.StuHelperAIError {
	if err == nil {
		return nil
	}
...
func shouldChargeViolationFee(err *types.StuHelperAIError) bool {
	if err == nil {
		return false
	}
...
func ChargeViolationFeeIfNeeded(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, apiErr *types.StuHelperAIError) bool {
