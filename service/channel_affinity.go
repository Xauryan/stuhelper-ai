...
const (
	...
	channelAffinityCacheNamespace           = "StuHelper AI:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "StuHelper AI:channel_affinity_usage_cache_stats:v1"
)
