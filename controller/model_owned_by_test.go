...
func TestChannelOwnerNameUsesAdaptorChannelName(t *testing.T) {
	tests := []struct {
		...
		{name: "openai", channelType: constant.ChannelTypeOpenAI, expected: "openai"},
		{name: "codex", channelType: constant.ChannelTypeCodex, expected: "codex"},
		{name: "openrouter", channelType: constant.ChannelTypeOpenRouter, expected: "openrouter"},
		{name: "azure fallback", channelType: constant.ChannelTypeAzure, expected: "azure"},
	}
