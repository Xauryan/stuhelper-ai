...
import (
	...
	"github.com/Xauryan/stuhelper-ai/relay/channel/ai360"
	"github.com/Xauryan/stuhelper-ai/relay/channel/lingyiwanwu"

	//"github.com/Xauryan/stuhelper-ai/relay/channel/minimax"
	"github.com/Xauryan/stuhelper-ai/relay/channel/openrouter"
	"github.com/Xauryan/stuhelper-ai/relay/channel/xinference"
	relaycommon "github.com/Xauryan/stuhelper-ai/relay/common"
	"github.com/Xauryan/stuhelper-ai/relay/common_handler"
...
func (a *Adaptor) SetupRequestHeader(c *gin.Context, header *http.Header, info *relaycommon.RelayInfo) error {
	...
	if info.ChannelType == constant.ChannelTypeOpenRouter {
		if header.Get("HTTP-Referer") == "" {
			header.Set("HTTP-Referer", "https://www.stuhelper-ai.ai")
		}
		if header.Get("X-OpenRouter-Title") == "" {
			header.Set("X-OpenRouter-Title", "StuHelper AI")
		}
	}
	return nil
}
