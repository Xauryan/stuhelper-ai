...
func cfStreamHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.StuHelperAIError, *dto.Usage) {
...
func cfHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.StuHelperAIError, *dto.Usage) {
...
func cfSTTHandler(c *gin.Context, info *relaycommon.RelayInfo, resp *http.Response) (*types.StuHelperAIError, *dto.Usage) {
