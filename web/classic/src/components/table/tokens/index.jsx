...
function TokensPage() {
  ...
  function openFluentNotification(key) {
    ...
    const container = document.getElementById('fluent-stuhelper-ai-container');
    if (!container) {
  ...
  useEffect(() => {
    const selector = '#fluent-stuhelper-ai-container';
    ...
    const isOrContainsTarget = (node) => {
      ...
      if (node.id === 'fluent-stuhelper-ai-container') return true;
      return (
