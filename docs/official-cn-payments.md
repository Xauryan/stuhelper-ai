...
配置 `service_fee_percent`；官方支付宝、官方微信和 Waffo Pancake 分别使用
`AlipayOfficialServiceFeePercent`、`WechatPayOfficialServiceFeePercent` 和
`WaffoPancakeServiceFeePercent`。单位均为百分比，留空或未配置表示 `0`。
